  ...
  <ul class="dropdown-menu pull-right cart-menu">
    ...
    <li>
      <div>
        ...
        <div class="text-right button-container"><a href="<?php echo $cart; ?>" class="addtocart"><?php echo $text_cart; ?></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $checkout; ?>" class="checkout"><?php echo $text_checkout; ?></a></div>
      </div>
    </li>
    <?php } else { ?>
    <li>
