  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="productpage <?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
		...
		<?php if ($column_left && $column_right) { ?>
        <?php $class = 'col-sm-4 product-left'; ?>
        <?php } elseif ($column_left || $column_right) { ?>
        <?php $class = 'col-sm-4 product-left'; ?>
        <?php } else { ?>
    ...
    <?php } ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
            ...
            <?php } else { ?>
            <li class="old"><span class="old-price" style="text-decoration: line-through;"><?php echo $price; ?></span></li>
            <li class="special">
              <h2 class="special-price"><?php echo $special; ?></h2>
            </li>
            <?php } ?>
            <?php if ($tax) { ?>
            <li class="tax"><?php echo $text_tax; ?><span class="price-tax"><?php echo $tax; ?></span></li>
            <?php } ?>
            <?php if ($points) { ?>
          ...
          <div id="product">
		    ...
		    <span class="links">
            <div class="wishlist"><button type="button" data-toggle="tooltip" class="btn btn-default wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><?php echo $button_wishlist; ?></button></div>
            <div class="compare"><button type="button" data-toggle="tooltip" class="btn btn-default compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i><?php echo $button_compare; ?></button></div>
         </span>
			<?php if ($minimum > 1) { ?>
			...
			?>
				...
				<div class="<?php if ($productCount >= $sliderFor){?>slider-item<?php }else{?>product-items<?php }?>">
					...
					<?php /*?>  <p><?php echo $product['description']; ?></p><?php */?>
					  ...
					  <?php } ?>
					  <div class="cart">
					  <button type="button" class="addtocart" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><span><?php echo $button_cart; ?></span></button>
					  </div>
					</div>
					<div class="button-group">
					
					   
					  <button type="button" class="compare"  title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i></button>
					  <button type="button" class="wishlist" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-exchange"></i></button>
					</div>
					</div>
