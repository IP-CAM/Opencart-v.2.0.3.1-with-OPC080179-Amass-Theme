...
<div id="content">
	...
	<div class="box">
		...
		<?php foreach ($modules as $module) { ?>
			...
			<?php if ($module['position'] == 'content_footer_contact') { ?>
			<option value="content_footer_contact" selected="selected"><?php echo $text_content_footer_contact; ?></option>
			<?php } else { ?>
			<option value="content_footer_contact"><?php echo $text_content_footer_contact; ?></option>
			<?php } ?>
			
			<?php if ($module['position'] == 'content_header_callus') { ?>
			<option value="content_header_callus" selected="selected"><?php echo $text_content_header_callus; ?></option>
			<?php } else { ?>
			<option value="content_header_callus"><?php echo $text_content_header_callus; ?></option>
			<?php } ?>
			
			<?php if ($module['position'] == 'content_product') { ?>
			<option value="content_product" selected="selected"><?php echo $text_content_product; ?></option>
			<?php } else { ?>
			<option value="content_product"><?php echo $text_content_product; ?></option>
			<?php } ?>
			...
			<table id="layout_sort_<?php echo $module_row; ?>" class="form" style=" <?php if (($module['position'] == 'content_footer') || ($module['position'] == 'content_footer_contact') || ($module['position'] == 'content_header_callus') || ($module['position'] == 'content_product')) echo 'display:none'; else echo 'display:block';?>" cl > 
...
html += '        <option value="content_footer_contact"><?php echo $text_content_footer_contact; ?></option>';
html += '        <option value="content_header_callus"><?php echo $text_content_header_callus; ?></option>';
html += '        <option value="content_product"><?php echo $text_content_product; ?></option>';
html += '      </select></td>';
html += '    </tr>';
html += '    <tr>';
...
{
if(val=='content_footer' || val=='content_footer_contact' || val=='content_header_callus' || val=='content_product') 
{
